...
// ═══════════════════════════════════════════════════════════════════════════════
// ETERNAL GARDEN - Epic generative ambient showcasing structural evolution
// ═══════════════════════════════════════════════════════════════════════════════
// Uses Scene Chain to progress through 4 distinct moods over time.
// Crossfaders morph between textures, Counters trigger events, Comparators
// create moments of change. A true demonstration of long-form generative music.

export const ETERNAL_GARDEN_PATCH: Patch = {
  version: '1.0',
  meta: {
    name: 'Eternal Garden',
    created: new Date().toISOString(),
  ...
  nodes: [
    // ═══════════════════════════════════════════════════════════════════════
    // MASTER TIMING - Slow tempo for spacious ambient feel
    // Scene Chain progresses every 32 beats through 4 moods
    // ═══════════════════════════════════════════════════════════════════════
    { id: 'masterClock', type: 'clock', position: { x: 50, y: 300 }, params: { bpm: 60, running: true, swing: 0 } },
    { id: 'sceneChain', type: 'sequencechain', position: { x: 200, y: 300 }, params: { scenes: 4, stepsPerScene: 32, mode: 'forward', loop: true } },
    { id: 'divSlow', type: 'clockdiv', position: { x: 200, y: 400 }, params: {} },

    // ═══════════════════════════════════════════════════════════════════════
    // LAYER 1: ETERNAL PAD - Slowly morphing drone foundation
    // Two detuned oscillators through wavefolder, filter modulated by glacial LFO
    // ═══════════════════════════════════════════════════════════════════════
    { id: 'lfoPad', type: 'lfo', position: { x: 50, y: 50 }, params: { rate: 0.008, depth: 400, waveform: 'sine' } },
    { id: 'lfoFold', type: 'lfo', position: { x: 50, y: 130 }, params: { rate: 0.012, depth: 0.4, waveform: 'triangle' } },
    { id: 'oscPad1', type: 'oscillator', position: { x: 200, y: 50 }, params: { frequency: 55, detune: 0, waveform: 'sawtooth' } },
    { id: 'oscPad2', type: 'oscillator', position: { x: 200, y: 130 }, params: { frequency: 55.1, detune: 5, waveform: 'sawtooth' } },
    { id: 'mixPad', type: 'mixer', position: { x: 350, y: 90 }, params: { level1: 0.5, level2: 0.5, level3: 0, level4: 0, master: 0.6 } },
    { id: 'foldPad', type: 'wavefolder', position: { x: 500, y: 90 }, params: { drive: 1.0, folds: 2, mix: 0.5 } },
    { id: 'filterPad', type: 'filter', position: { x: 650, y: 90 }, params: { mode: 'lowpass', cutoff: 400, resonance: 2 } },
    { id: 'vcaPad', type: 'vca', position: { x: 800, y: 90 }, params: { gain: 0.25 } },

    // ═══════════════════════════════════════════════════════════════════════
    // LAYER 2: MELODIC VOICE A - Pentatonic dreams (Scenes 1 & 3)
    // Turing machine through quantizer, euclidean triggers
    // ═══════════════════════════════════════════════════════════════════════
    { id: 'euclidA', type: 'euclidean', position: { x: 350, y: 250 }, params: { steps: 16, hits: 5, rotation: 0, running: true } },
    { id: 'turingA', type: 'turing', position: { x: 350, y: 350 }, params: { probability: 0.15, length: 16, scale: 1.0, locked: false } },
    { id: 'slewA', type: 'slewlimiter', position: { x: 500, y: 350 }, params: { rise: 0.08, fall: 0.15, shape: 'exponential' } },
    { id: 'quantA', type: 'quantizer', position: { x: 650, y: 350 }, params: { scale: 'pentatonic', root: 0, octaves: 2 } },
    { id: 'oscA', type: 'oscillator', position: { x: 800, y: 300 }, params: { frequency: 220, detune: 0, waveform: 'triangle' } },
    { id: 'adsrA', type: 'adsr', position: { x: 650, y: 250 }, params: { attack: 0.02, decay: 0.4, sustain: 0.3, release: 1.2 } },
    { id: 'filterA', type: 'filter', position: { x: 950, y: 300 }, params: { mode: 'lowpass', cutoff: 1800, resonance: 3 } },
    { id: 'vcaA', type: 'vca', position: { x: 1100, y: 300 }, params: { gain: 0.6 } },

    // ═══════════════════════════════════════════════════════════════════════
    // LAYER 3: MELODIC VOICE B - Crystalline bells (Scenes 2 & 4)
    // Karplus-Strong with different rhythm
    // ═══════════════════════════════════════════════════════════════════════
    { id: 'euclidB', type: 'euclidean', position: { x: 350, y: 500 }, params: { steps: 12, hits: 3, rotation: 2, running: true } },
    { id: 'turingB', type: 'turing', position: { x: 350, y: 600 }, params: { probability: 0.2, length: 12, scale: 0.8, locked: false } },
    { id: 'slewB', type: 'slewlimiter', position: { x: 500, y: 600 }, params: { rise: 0.05, fall: 0.1, shape: 'linear' } },
    { id: 'quantB', type: 'quantizer', position: { x: 650, y: 600 }, params: { scale: 'minor', root: 0, octaves: 2 } },
    { id: 'probB', type: 'probgate', position: { x: 500, y: 500 }, params: { probability: 0.7, mode: 'gate' } },
    { id: 'stringB', type: 'karplusstrong', position: { x: 800, y: 550 }, params: { frequency: 440, damping: 0.3, feedback: 0.985, brightness: 0.8, pluck: 0.6 } },
    { id: 'attenB', type: 'attenuverter', position: { x: 950, y: 550 }, params: { amount: 0.5 } },

    // ═══════════════════════════════════════════════════════════════════════
    // CROSSFADER - Morph between Voice A and Voice B based on scene
    // Creates smooth transitions as scenes change
    // ═══════════════════════════════════════════════════════════════════════
    { id: 'crossfadeVoices', type: 'crossfader', position: { x: 1250, y: 420 }, params: { position: 0, curve: 'equal_power' } },

    // ═══════════════════════════════════════════════════════════════════════
    // LAYER 4: DEEP BASS - Slow evolving foundation
    // Switches between two bass characters every 16 beats
    // ═══════════════════════════════════════════════════════════════════════
    { id: 'counterBass', type: 'counter', position: { x: 350, y: 750 }, params: { count: 16, mode: 'up', autoReset: true } },
    { id: 'oscBass1', type: 'oscillator', position: { x: 500, y: 720 }, params: { frequency: 36.7, detune: 0, waveform: 'sine' } },
    { id: 'oscBass2', type: 'oscillator', position: { x: 500, y: 800 }, params: { frequency: 55, detune: 0, waveform: 'triangle' } },
    { id: 'switchBass', type: 'switch', position: { x: 700, y: 760 }, params: { channels: 2, mode: 'sequential', position: 0, smooth: 200 } },
    { id: 'filterBass', type: 'filter', position: { x: 850, y: 760 }, params: { mode: 'lowpass', cutoff: 200, resonance: 1 } },
    { id: 'vcaBass', type: 'vca', position: { x: 1000, y: 760 }, params: { gain: 0.35 } },

    // ═══════════════════════════════════════════════════════════════════════
    // LAYER 5: ATMOSPHERIC TEXTURE - Granular clouds
    // Smooth random modulates grain parameters for organic movement
    // ═══════════════════════════════════════════════════════════════════════
    { id: 'noiseAtmo', type: 'noise', position: { x: 50, y: 900 }, params: { type: 'pink' } },
    { id: 'smoothRnd', type: 'smoothrandom', position: { x: 50, y: 980 }, params: { rate: 0.05, range: 0.3, smooth: 0.9 } },
    { id: 'granularAtmo', type: 'granular', position: { x: 200, y: 940 }, params: { grainSize: 200, density: 6, spray: 0.4, pitch: 0.5, position: 0.5, freeze: false, mix: 1.0, reverse: 0.4 } },
    { id: 'filterAtmo', type: 'filter', position: { x: 400, y: 940 }, params: { mode: 'bandpass', cutoff: 600, resonance: 4 } },
    { id: 'vcaAtmo', type: 'vca', position: { x: 550, y: 940 }, params: { gain: 0.15 } },

    // ═══════════════════════════════════════════════════════════════════════
    // LAYER 6: MOMENT TRIGGERS - Comparator creates surprise events
    // When smooth random crosses threshold, trigger special accent
    // ═══════════════════════════════════════════════════════════════════════
    { id: 'smoothMoment', type: 'smoothrandom', position: { x: 50, y: 1100 }, params: { rate: 0.02, range: 1, smooth: 0.7 } },
    { id: 'compareMoment', type: 'comparator', position: { x: 200, y: 1100 }, params: { threshold: 0.8, mode: 'greater', windowSize: 0.1, hysteresis: 0.1 } },
    { id: 'stringAccent', type: 'karplusstrong', position: { x: 400, y: 1100 }, params: { frequency: 880, damping: 0.2, feedback: 0.99, brightness: 0.95, pluck: 0.9 } },
    { id: 'attenAccent', type: 'attenuverter', position: { x: 600, y: 1100 }, params: { amount: 0.25 } },

    // ═══════════════════════════════════════════════════════════════════════
    // MAIN MIXER - Combine all layers
    // ═══════════════════════════════════════════════════════════════════════
    { id: 'mixMain', type: 'mixer', position: { x: 1400, y: 600 }, params: { level1: 1, level2: 0.9, level3: 0.8, level4: 0.7, master: 0.6 } },

    // ═══════════════════════════════════════════════════════════════════════
    // EFFECTS - Lush reverbs and subtle delays
    // ═══════════════════════════════════════════════════════════════════════
    { id: 'delay1', type: 'delay', position: { x: 1550, y: 500 }, params: { time: 0.666, feedback: 0.35, mix: 0.25 } },
    { id: 'delay2', type: 'delay', position: { x: 1550, y: 700 }, params: { time: 1.0, feedback: 0.3, mix: 0.2 } },
    { id: 'reverbMain', type: 'reverb', position: { x: 1700, y: 600 }, params: { decay: 8, mix: 0.55 } },

    // OUTPUT
    { id: 'output', type: 'output', position: { x: 1850, y: 600 }, params: { gain: 0.5 } },
  ],
  connections: [
    // === Master timing distribution ===
    { id: 't1', from: { nodeId: 'masterClock', port: 'output' }, to: { nodeId: 'sceneChain', port: 'clock' } },
    { id: 't2', from: { nodeId: 'masterClock', port: 'output' }, to: { nodeId: 'divSlow', port: 'input' } },
    { id: 't3', from: { nodeId: 'masterClock', port: 'output' }, to: { nodeId: 'euclidA', port: 'clock' } },
    { id: 't4', from: { nodeId: 'masterClock', port: 'output' }, to: { nodeId: 'turingA', port: 'clock' } },
    { id: 't5', from: { nodeId: 'divSlow', port: 'div2' }, to: { nodeId: 'euclidB', port: 'clock' } },
    { id: 't6', from: { nodeId: 'divSlow', port: 'div2' }, to: { nodeId: 'turingB', port: 'clock' } },
    { id: 't7', from: { nodeId: 'masterClock', port: 'output' }, to: { nodeId: 'counterBass', port: 'trigger' } },

    // === Scene chain controls crossfader position ===
    { id: 'sc1', from: { nodeId: 'sceneChain', port: 'output' }, to: { nodeId: 'crossfadeVoices', port: 'cv' } },

    // === Layer 1: Eternal Pad ===
    { id: 'p1', from: { nodeId: 'lfoPad', port: 'output' }, to: { nodeId: 'filterPad', port: 'cutoff_mod' } },
    { id: 'p2', from: { nodeId: 'lfoFold', port: 'output' }, to: { nodeId: 'foldPad', port: 'drive_mod' } },
    { id: 'p3', from: { nodeId: 'oscPad1', port: 'output' }, to: { nodeId: 'mixPad', port: 'input1' } },
    { id: 'p4', from: { nodeId: 'oscPad2', port: 'output' }, to: { nodeId: 'mixPad', port: 'input2' } },
    { id: 'p5', from: { nodeId: 'mixPad', port: 'output' }, to: { nodeId: 'foldPad', port: 'input' } },
    { id: 'p6', from: { nodeId: 'foldPad', port: 'output' }, to: { nodeId: 'filterPad', port: 'input' } },
    { id: 'p7', from: { nodeId: 'filterPad', port: 'output' }, to: { nodeId: 'vcaPad', port: 'input' } },
    { id: 'p8', from: { nodeId: 'vcaPad', port: 'output' }, to: { nodeId: 'mixMain', port: 'input1' } },

    // === Layer 2: Voice A (pentatonic) ===
    { id: 'a1', from: { nodeId: 'euclidA', port: 'output' }, to: { nodeId: 'adsrA', port: 'trigger' } },
    ...
    { id: 'a4', from: { nodeId: 'quantA', port: 'output' }, to: { nodeId: 'oscA', port: 'freq_mod' } },
    { id: 'a5', from: { nodeId: 'oscA', port: 'output' }, to: { nodeId: 'filterA', port: 'input' } },
    { id: 'a6', from: { nodeId: 'adsrA', port: 'output' }, to: { nodeId: 'vcaA', port: 'gain_mod' } },
    { id: 'a7', from: { nodeId: 'adsrA', port: 'output' }, to: { nodeId: 'filterA', port: 'cutoff_mod' } },
    { id: 'a8', from: { nodeId: 'filterA', port: 'output' }, to: { nodeId: 'vcaA', port: 'input' } },
    { id: 'a9', from: { nodeId: 'vcaA', port: 'output' }, to: { nodeId: 'crossfadeVoices', port: 'inputA' } },

    // === Layer 3: Voice B (bells) ===
    { id: 'b1', from: { nodeId: 'euclidB', port: 'output' }, to: { nodeId: 'probB', port: 'input' } },
    { id: 'b2', from: { nodeId: 'probB', port: 'output' }, to: { nodeId: 'stringB', port: 'trigger' } },
    { id: 'b3', from: { nodeId: 'turingB', port: 'output' }, to: { nodeId: 'slewB', port: 'input' } },
    { id: 'b4', from: { nodeId: 'slewB', port: 'output' }, to: { nodeId: 'quantB', port: 'input' } },
    { id: 'b5', from: { nodeId: 'quantB', port: 'output' }, to: { nodeId: 'stringB', port: 'freq_mod' } },
    { id: 'b6', from: { nodeId: 'stringB', port: 'output' }, to: { nodeId: 'attenB', port: 'input' } },
    { id: 'b7', from: { nodeId: 'attenB', port: 'output' }, to: { nodeId: 'crossfadeVoices', port: 'inputB' } },

    // === Crossfader to main mix ===
    { id: 'cf1', from: { nodeId: 'crossfadeVoices', port: 'output' }, to: { nodeId: 'mixMain', port: 'input2' } },

    // === Layer 4: Bass ===
    { id: 'bs1', from: { nodeId: 'counterBass', port: 'output' }, to: { nodeId: 'switchBass', port: 'trigger' } },
    { id: 'bs2', from: { nodeId: 'oscBass1', port: 'output' }, to: { nodeId: 'switchBass', port: 'input1' } },
    { id: 'bs3', from: { nodeId: 'oscBass2', port: 'output' }, to: { nodeId: 'switchBass', port: 'input2' } },
    { id: 'bs4', from: { nodeId: 'switchBass', port: 'output' }, to: { nodeId: 'filterBass', port: 'input' } },
    { id: 'bs5', from: { nodeId: 'filterBass', port: 'output' }, to: { nodeId: 'vcaBass', port: 'input' } },
    { id: 'bs6', from: { nodeId: 'vcaBass', port: 'output' }, to: { nodeId: 'mixMain', port: 'input3' } },
    ...
    // === Layer 6: Moment triggers ===
    { id: 'm1', from: { nodeId: 'smoothMoment', port: 'output' }, to: { nodeId: 'compareMoment', port: 'input' } },
    { id: 'm2', from: { nodeId: 'compareMoment', port: 'output' }, to: { nodeId: 'stringAccent', port: 'trigger' } },
    { id: 'm3', from: { nodeId: 'stringAccent', port: 'output' }, to: { nodeId: 'attenAccent', port: 'input' } },
    { id: 'm4', from: { nodeId: 'attenAccent', port: 'output' }, to: { nodeId: 'delay1', port: 'input' } },

    // === Effects chain ===
    { id: 'fx1', from: { nodeId: 'mixMain', port: 'output' }, to: { nodeId: 'delay1', port: 'input' } },
    { id: 'fx2', from: { nodeId: 'mixMain', port: 'output' }, to: { nodeId: 'delay2', port: 'input' } },
    { id: 'fx3', from: { nodeId: 'delay1', port: 'output' }, to: { nodeId: 'reverbMain', port: 'input' } },
    { id: 'fx4', from: { nodeId: 'delay2', port: 'output' }, to: { nodeId: 'reverbMain', port: 'input' } },
    { id: 'fx5', from: { nodeId: 'reverbMain', port: 'output' }, to: { nodeId: 'output', port: 'input' } },
  ],
  groups: [],
};
